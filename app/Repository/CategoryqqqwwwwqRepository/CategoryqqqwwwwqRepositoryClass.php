...
namespace App\Repository\CategoryqqqwwwwqRepository;
 ...
 use App\Models\Categoryqqqwwwwq;
...
class CategoryqqqwwwwqRepositoryClass implements CategoryqqqwwwwqRepositoryInterface
{
    /**
    ...
    {
       return Helpers::resultExist(Categoryqqqwwwwq::create($data));
    }
    ...
    {
        return Categoryqqqwwwwq::where('id',$id)->first();
    }
    /**
     * @param $id
     */
