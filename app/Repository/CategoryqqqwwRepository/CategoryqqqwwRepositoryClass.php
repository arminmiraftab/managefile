...
namespace App\Repository\CategoryqqqwwRepository;

 use App\Models\Categoryqqqww;
...
class CategoryqqqwwRepositoryClass implements CategoryqqqwwRepositoryInterface
{
    /**
    ...
    {
       return Helpers::resultExist(Categoryqqqww::create($data));
    }
    ...
    {
        return Categoryqqqww::where('id',$id)->first();
    }
    /**
     * @param $id
     */
